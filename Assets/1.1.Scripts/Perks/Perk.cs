...
public class Perk
{
    ...
    //public List<Buff> requiredPerks;
    ...
    public void MakeBuffActive()
    {
        // SetThisBuff();
        //  AbilityManager.MyInstance.SetPassive(buff);
    }
    public void MakeBuffInActive()
    {
        // SetThisBuff();
        // AbilityManager.MyInstance.RemovePassive(buff);
    }
}
